        ...
        <div className="max-w-[800px] lg:w-full grid grid-cols-1 lg:grid-cols-3 gap-4 m-auto mt-8 w-[90%]">
            <div className="relative bg-white w-full min-h-[200px] overflow-hidden flex items-center justify-center rounded-3xl shadow-md">
                ...
                <div className="flex flex-col gap-1 z-10">
                    ...
                    <p className="flex gap-1 items-center justify-center text-xl"><FaRegSun className="text-yellow-500" />16.7 °C</p>
                </div>
            </div>
            <div className="relative bg-white w-full min-h-[200px] overflow-hidden flex items-center justify-center rounded-3xl shadow-md">
                ...
                <div className="flex flex-col gap-1 z-10">
                    ...
                    <p className="flex gap-1 items-center justify-center text-xl">V</p>
                </div>
            </div>
            <div className="relative bg-white w-full min-h-[200px] overflow-hidden flex items-center justify-center rounded-3xl shadow-md">
            ...
            <div className="relative bg-white w-full min-h-[200px] overflow-hidden flex items-center justify-center rounded-3xl shadow-md">
                ...
                <div className="flex flex-col gap-1 z-10">
                    ...
                    <p className="flex gap-1 items-center justify-center text-xl">0</p>
                </div>
            </div>
            <div className="relative bg-white w-full min-h-[200px] overflow-hidden flex items-center justify-center rounded-3xl shadow-md">
            ...
            <div className="relative bg-white w-full min-h-[200px] overflow-hidden flex items-center justify-center rounded-3xl shadow-md">
                ...
                <div className="flex flex-col gap-1 z-10">
                    ...
                    <p className="flex gap-1 items-center justify-center text-xl">Dolu</p>
                </div>
            </div>
            <div className="relative bg-white w-full min-h-[200px] overflow-hidden flex items-center justify-center rounded-3xl shadow-md">
            ...
            <div className="relative bg-white w-full min-h-[200px] overflow-hidden flex items-center justify-center rounded-3xl shadow-md">
                ...
                <div className="flex flex-col gap-1 z-10">
                    <p className="text-xl"><BsFillLightbulbFill className="text-4xl m-auto mb-3 text-green-500"/></p>
